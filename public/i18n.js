...
const I18N = {
  bn: {
    ...
    voice_ready: 'ভয়েস চালু করতে প্রস্তুত',
    voice_waiting_for_opponent: 'প্রতিপক্ষের জন্য অপেক্ষা',
    voice_enable: 'ভয়েস চালু করুন',
    voice_mute: 'মিউট',
    voice_unmute: 'আনমিউট',
    voice_error: 'ভয়েস এনাবল করতে ব্যর্থ',
    voice_connecting: 'ভয়েস সংযোগ হচ্ছে…',
    voice_connected: 'ভয়েস সংযোগ স্থাপন হয়েছে',
    voice_no_mic: 'মাইক্রোফোন পাওয়া যায়নি',
    voice_not_ready: 'ভয়েস চ্যাটের জন্য প্রস্তুত নয়',
    lang_toggle: 'English',
  ...
  en: {
    ...
    voice_ready: 'Ready for voice',
    voice_waiting_for_opponent: 'Waiting for opponent',
    voice_enable: 'Enable voice',
    voice_mute: 'Mute',
    voice_unmute: 'Unmute',
    voice_error: 'Could not enable voice',
    voice_connecting: 'Connecting voice…',
